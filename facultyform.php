...
class Contact{
    ...
    public function faculty_fb($data){
        $fname=$data['name'];
        $lname=$data['surname'];
        $email=$data['email'];
        $phone=$data['phone'];
       ...
       if($data==true){
           ...
           return $this->sent_mail("dcetresources@gmail.com", "Message received from mohtashim", $body);
       }
    }
    
    public function sent_mail($to,$subject,$body){
$mailFromName="mohtashim";
$mailFrom="dcetresources@gmail.com";
/////////////////////////////////////////////////////////////
//Mail Header
